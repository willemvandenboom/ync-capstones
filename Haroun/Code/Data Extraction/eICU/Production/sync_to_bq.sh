...
bq rm -f -t ync-capstones:NMB_eICU.eicu_oxygen_therapy

# template
# bq mk --use_legacy_sql=false --view "$(cat icd_codes.sql)" oxygenators-209612:mimiciii_clinical.icd_codes

bq mk --use_legacy_sql=false --view "$(cat eicu_oxygen_therapy.sql)" ync-capstones:NMB_eICU.eicu_oxygen_therapy
